...
dataset_id                  = "bigquery_dataset_test"
friendly_name               = "A BigQuery dataset test"
location                    = "europe-west2"
description                 = "Test BigQuery dataset"
default_table_expiration_ms = 3700000
...
iam_binding = {
  "roles/bigquery.user"= ["serviceAccount:svc-cpt-ingestion-ms-user@dmn01-cptcda-bld-01-b1d3.iam.gserviceaccount.com",
                "serviceAccount:svc-cpt-curation-ms-user@dmn01-cptcda-bld-01-b1d3.iam.gserviceaccount.com"]
  "roles/bigquery.admin"= ["serviceAccount:svc-cpt-ingestion-ms-user@dmn01-cptcda-bld-01-b1d3.iam.gserviceaccount.com",
                "serviceAccount:svc-cpt-curation-ms-user@dmn01-cptcda-bld-01-b1d3.iam.gserviceaccount.com"]
}
