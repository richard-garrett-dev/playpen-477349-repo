...
dataset_id                  = "dmn01_cpt_bqd_cardauthraw"
friendly_name               = "A BigQuery dataset for data platform raw records"
location                    = "europe-west2"
description                 = "SOI Raw BigQuery Dataset"
...
access_config = {
  ...
  "dataEditor" = {
    ...
    user_by_email  = "svc-cpt-auth-curation-ms-user@dmn01-cptcda-bld-01-b1d3.iam.gserviceaccount.com"
  },
  "dataEditor" = {
    role           = "roles/bigquery.dataEditor"
    user_by_email  = "svc-cards-bq-connect@sbs-kaf-bld-01-6362.iam.gserviceaccount.com"
  }
}
