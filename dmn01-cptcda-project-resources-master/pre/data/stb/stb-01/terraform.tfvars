...
region             = "europe-west2"
bucket_name        = "dmn01-cda-pre-01-stb-euwe2-soidplanding-01"
...
bucket_notifications = {
  notification-one = {
    topic = "projects/dmn01-cptcda-pre-01-b039/topics/cards-soi-internal-orch",
...
iam_binding = {
  "roles/storage.objectAdmin" = [
     "serviceAccount:svc-stb-fth-objmgr@sbs-fth-pre-01-e32a.iam.gserviceaccount.com"
  ]
