...
region             = "europe-west2"
bucket_name        = "dmn01-cda-bld-01-stb-euwe2-cardauthaxbnslanding-01"
...
//  notification-one = {
//    topic = "projects/dmn01-cptcda-bld-01-b1d3/topics/cards-soi-internal-orch",
...
iam_binding = {
  ...
  "roles/storage.admin" = ["group:gg_dmn01-cptcda-bld_dataeng@e.lloydsbanking.com",
	"serviceAccount:svc-cpt-auth-curation-ms-user@dmn01-cptcda-bld-01-b1d3.iam.gserviceaccount.com"]
}
