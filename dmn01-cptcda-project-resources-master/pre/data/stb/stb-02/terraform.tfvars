...
region             = "europe-west2"
bucket_name        = "dmn01-cda-pre-01-stb-euwe2-soidpingconfig-01"
...
//It will delete all the object updated with Age 7 days and the current storage class is COLDLINE(Minimum age to keep in coldline is 90 days)
...
iam_binding = {
  ...
  "roles/storage.admin" = ["group:gg_dmn01-cptcda-pre_dataeng@e.lloydsbanking.com",
    "serviceAccount:svc-cpt-orchestrator-ms-user@dmn01-cptcda-pre-01-b039.iam.gserviceaccount.com",
    "serviceAccount:svc-cpt-curation-ms-user@dmn01-cptcda-pre-01-b039.iam.gserviceaccount.com",
    "serviceAccount:svc-cpt-ingestion-ms-user@dmn01-cptcda-pre-01-b039.iam.gserviceaccount.com"]
}

kms_project_id = "dmn01-cptkms-pre-01-8fbb"
