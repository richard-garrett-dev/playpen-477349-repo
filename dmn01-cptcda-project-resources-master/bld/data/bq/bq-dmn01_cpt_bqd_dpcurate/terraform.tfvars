...
dataset_id                  = "dmn01_cpt_bqd_dpcurate"
friendly_name               = "A BigQuery dataset for curation"
location                    = "europe-west2"
description                 = "Curation BigQuery dataset"
...
time_partitioning = {
  bns_dr_card_auth_txn_curate_i = {
	...
	expiration_ms = 63072000000
  }
}

views = ["v_acquire_country",
         "v_card_data_entry_mode",
         "v_chip_condition_code",
         "v_cvv2_result_code",
         "v_lbg_response_code",
         "v_mail_phone_electronic_commerce_and_payment_indicator",
         "v_merchant_category_code",
         "v_pos_environment",
         "v_transaction_attribute",
         "v_transaction_type",
         "v_visa_response_code"]
